			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form class="form-horizontal" action="#" method="get">
						...
						<div class="form-group">
							<label for="exampleInputFirstName" class="col-sm-2 control-label">First
								name</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="exampleInputLastName" class="col-sm-2 control-label">Last
								name</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="exampleInputSecondName"
								class="col-sm-2 control-label">Second name</label>
							<div class="col-sm-10">
								<input name="secondName" class="form-control"
									id="exampleInputsecondName" placeholder="second Name">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" value="2">Advanced tutor</label> 
									<label> <input type="checkbox" value="3">Tutor</label> 
									<label> <input type="checkbox" value="4">Student</label>
								</div>
							</div>
						</div>
